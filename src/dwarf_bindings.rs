...
pub const DW_DLA_STRING           = 0x01     /* char* */
pub const DW_DLA_LOC              = 0x02     /* Dwarf_Loc */
pub const DW_DLA_LOCDESC          = 0x03     /* Dwarf_Locdesc */
pub const DW_DLA_ELLIST           = 0x04     /* Dwarf_Ellist (not used)*/
pub const DW_DLA_BOUNDS           = 0x05     /* Dwarf_Bounds (not used) */
pub const DW_DLA_BLOCK            = 0x06     /* Dwarf_Block */
pub const DW_DLA_DEBUG            = 0x07     /* Dwarf_Debug */
pub const DW_DLA_DIE              = 0x08     /* Dwarf_Die */
pub const DW_DLA_LINE             = 0x09     /* Dwarf_Line */
pub const DW_DLA_ATTR             = 0x0a     /* Dwarf_Attribute */
pub const DW_DLA_TYPE             = 0x0b     /* Dwarf_Type  (not used) */
pub const DW_DLA_SUBSCR           = 0x0c     /* Dwarf_Subscr (not used) */
pub const DW_DLA_GLOBAL           = 0x0d     /* Dwarf_Global */
pub const DW_DLA_ERROR            = 0x0e     /* Dwarf_Error */
pub const DW_DLA_LIST             = 0x0f     /* a list */
pub const DW_DLA_LINEBUF          = 0x10     /* Dwarf_Line* (not used) */
pub const DW_DLA_ARANGE           = 0x11     /* Dwarf_Arange */
pub const DW_DLA_ABBREV           = 0x12      /* Dwarf_Abbrev */
pub const DW_DLA_FRAME_OP         = 0x13      /* Dwarf_Frame_Op */
pub const DW_DLA_CIE              = 0x14     /* Dwarf_Cie */
pub const DW_DLA_FDE              = 0x15     /* Dwarf_Fde */
pub const DW_DLA_LOC_BLOCK        = 0x16     /* Dwarf_Loc Block (not used) */
pub const DW_DLA_FRAME_BLOCK      = 0x17     /* Dwarf_Frame Block (not used) */
pub const DW_DLA_FUNC             = 0x18     /* Dwarf_Func */
pub const DW_DLA_TYPENAME         = 0x19     /* Dwarf_Type */
pub const DW_DLA_VAR              = 0x1a     /* Dwarf_Var */
pub const DW_DLA_WEAK             = 0x1b     /* Dwarf_Weak */
pub const DW_DLA_ADDR             = 0x1c     /* Dwarf_Addr sized entries */
pub const DW_DLA_RANGES           = 0x1d     /* Dwarf_Ranges */
